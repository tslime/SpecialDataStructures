...
class PQueue<T1,T3>{
    ...
    public PQueue(int size){
        this.size = size;
        this.vd = (Vertex<T1,T3>[])new Vertex[size]; 
        this.num_vd = 0;

        for(int i=0;i<size;i++){
            vd[i] = new Vertex<>(null,null,null);
            vd[i] = null;
        }

    }

    public static<T1,T3> void printQ(PQueue<T1,T3> q){
    ...
    @SuppressWarnings("unchecked")
    public static<T1,T3> void dsizePQueue(PQueue<T1,T3> q){

        PQueue<T1,T3> temp = new PQueue<>(2*q.size);
    ...
    public static<T1,T3> Vertex<T1,T3> peek(PQueue<T1,T3> q){
    ...
    public static<T1,T3> void insert(PQueue<T1,T3> q,Vertex<T1,T3> v){
    ...
    public static<T1,T3> void bubbleUP(PQueue<T1,T3> q,int last_element_index){
    ...
    public static<T1,T3> Vertex<T1,T3> pop(PQueue<T1,T3> q){
        
        Vertex<T1,T3> res = q.vd[0];
    ...
    public static<T1,T3> void bubbleDown(PQueue<T1,T3> q){
...
public static void main(String args[]){
    ...
    while(n>0){
        ...
        Vertex<String,String> vtmp = new Vertex<>(ltmp,id,dtmp);
